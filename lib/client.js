		...
		function SessionTree({ useSessions, useSessionPendingInteraction, startSession, open, forkSession, workspaces, archivedSessionIds, workspaceReady, usePanelInfo, onRenameRequest, onDeleteRequest, onSessionRename, onSessionArchive, onRepoRenameRequest, insertWorkspaceBefore, insertSessionBefore, orderBy, groupExpansion, setGroupExpanded, sessionOrderByAccount, sessionUpdatedAtByAccount, syncSessionOrderAccount, setSessionOrder, home, t, revealSessionId, onSessionRevealed, snapshot, worktrees }) {
			...
			*/
			const renderGroup = (group, nested) => {
				...
				const sessionsExpanded = expandedSessionGroups.includes(group.key);
				const workspaceMarker = !nested && workspaceId !== void 0 && workspaceDrag?.over?.ids.includes(workspaceId) ? workspaceDrag.over.half : null;
			...
			const workspaceDropAtListStart = firstRowId !== void 0 && workspaceDrag?.over?.ids[0] === firstRowId && workspaceDrag.over.half === "before";
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [groups.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							const sectionMarker = anchorId !== void 0 && workspaceDrag?.over?.ids.includes(anchorId) ? workspaceDrag.over.half : null;
