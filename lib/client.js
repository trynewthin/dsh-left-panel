window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function compareWorktreeGroups(mainPath) {
			return (a, b) => {
		...
		*/
		function planWorkspaceMove(order, moving, target) {
			...
			if (blockSet.has(target.id)) return void 0;
		...
		* @returns the row element.
		*/
		function RepoRowItem({ section, onToggle, onRefresh, onRename, drag, home, t }) {
			const { repo } = section;
			const [menuOpen, setMenuOpen] = (0, react.useState)(false);
		...
		function SessionTree({ useSessions, useSessionPendingInteraction, startSession, open, forkSession, workspaces, archivedSessionIds, workspaceReady, usePanelInfo, onRenameRequest, onDeleteRequest, onSessionRename, onSessionArchive, onRepoRenameRequest, insertWorkspaceBefore, insertSessionBefore, orderBy, groupExpansion, setGroupExpanded, sessionOrderByAccount, sessionUpdatedAtByAccount, syncSessionOrderAccount, setSessionOrder, home, t, revealSessionId, onSessionRevealed, snapshot, worktrees }) {
			...
			*/
			const renderGroup = (group, nested) => {
				...
				const sessionsExpanded = expandedSessionGroups.includes(group.key);
				const workspaceMarker = !nested && workspaceId !== void 0 && workspaceDrag?.over?.id === workspaceId ? workspaceDrag.over.half : null;
				const workspaceDragProps = workspaceId === void 0 || nested ? void 0 : {
					start: () => {
				...
				const hoverWorkspace = workspaceId === void 0 || nested ? void 0 : (half) => {
				...
				const dropWorkspace = workspaceId === void 0 || nested ? void 0 : (half) => {
			...
			const workspaceDropAtListStart = firstRowId !== void 0 && workspaceDrag?.over?.id === firstRowId && workspaceDrag.over.half === "before";
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [groups.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							const sectionMarker = anchorId !== void 0 && workspaceDrag?.over?.id === anchorId ? workspaceDrag.over.half : null;
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								onDragOver: workspaceDrag === null || anchorId === void 0 ? void 0 : (e) => {
									e.preventDefault();
									e.dataTransfer.dropEffect = "move";
									setWorkspaceDrag((active) => active === null ? active : {
										...active,
								...
								onDrop: workspaceDrag === null || anchorId === void 0 ? void 0 : (e) => {
									e.preventDefault();
									commitWorkspaceDrag(workspaceDrag, {
										id: anchorId,
										half: workspaceGroupHalf(e)
